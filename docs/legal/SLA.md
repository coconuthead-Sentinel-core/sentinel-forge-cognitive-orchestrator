...
|----------|------------------|
| Sentinel Forge Cognitive AI Orchestration Platform | All `/api/*` endpoints; Flask server availability |
| sentinel-forge-cognitive-orchestrator | All `/api/*` and `/api/ai/*` REST endpoints; WebSocket `/ws/*` |
| Sentinel Forge Cognitive AI Orchestration Platform | All REST endpoints; WebSocket endpoints; Voice processing pipeline |
