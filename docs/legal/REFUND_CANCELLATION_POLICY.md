...
This policy covers refunds and cancellations for all paid subscriptions across the Forge Trilogy platforms (Sentinel Forge Cognitive AI Orchestration Platform, sentinel-forge-cognitive-orchestrator, Sentinel Forge Cognitive AI Orchestration Platform).
...
- Your data is retained for 30 days after your billing period ends, then deleted (you can request earlier deletion)
...
### 4.1 New Subscriber Guarantee

If you are **not satisfied** with your first subscription period, you may request a full refund:

| Tier | Refund Window | Condition |
|------|--------------|-----------|
...
| Situation | Reason |
|-----------|--------|
| Unused API calls within your tier | API capacity was available; usage is not required for billing |
| Dissatisfaction with AI output quality | AI responses are probabilistic; quality cannot be guaranteed |
| Changed mind after refund window | Standard subscription billing |
| Account suspended for Terms violation | Suspension for prohibited use is not refundable |
| Downtime within SLA thresholds | SLA credits, not refunds, apply |

### 4.4 Enterprise

Enterprise refund and SLA credit terms are defined in your individual Enterprise Agreement and SLA. Contact [YOUR EMAIL].
